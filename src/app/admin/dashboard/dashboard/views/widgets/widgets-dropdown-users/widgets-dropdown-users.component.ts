...
@Component({
    selector: 'app-widgets-dropdown-users',
    templateUrl: './widgets-dropdown-users.component.html',
    styleUrls: ['./widgets-dropdown-users.component.scss'],
...
export class WidgetsDropdownComponentUsers implements OnInit, AfterContentInit {
